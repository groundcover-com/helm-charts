...
{{- printf "%s://%s:%s/%s" (include "victoria-metrics.read.http.scheme" .) (include "victoria-metrics.read.http.host" .) (include "victoria-metrics.read.http.port" .) (include "victoria-metrics.read.http.path" .) -}}
{{- end -}}
...
{{- if or .Values.global.backend.enabled .Values.global.metrics.overrideUrl -}}
    {{- printf "%s://%s:%s/%s" (include "victoria-metrics.write.http.scheme" .) (include "victoria-metrics.write.http.host" .) (include "victoria-metrics.write.http.port" .) (include "victoria-metrics.write.http.path" .) -}}
