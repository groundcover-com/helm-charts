...
| `statefulsetShardSelector.enabled`                  | Add the shard label to StatefulSet selectors. This changes an immutable field on existing StatefulSets and must be enabled only during a planned migration                                                         | `false`                      |
