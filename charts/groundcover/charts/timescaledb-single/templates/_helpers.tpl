...
{{- define "timescaledb.pvcWalName" -}}
{{- default "wal-volume" .Values.persistentVolumes.wal.pvcNameOverride -}}
{{- end -}}

{{- define "timescaledb.pvcDataName" -}}
{{- default "storage-volume" .Values.persistentVolumes.data.pvcNameOverride -}}
{{- end -}}
...
{{- if .Values.secrets.credentialsSecretName -}}
{{ .Values.secrets.credentialsSecretName }}
{{- else -}}
